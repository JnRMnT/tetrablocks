...
bool LTexture::loadFromRenderedText(SDL_Renderer* gRenderer, std::string textureText)
{
	return this->loadFromRenderedText(gRenderer, textureText, DefaultFontColor);
}
